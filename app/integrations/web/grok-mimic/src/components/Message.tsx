...
const Message: FC<{ message: Message; onReact: (reaction: string) => void; onCopy: () => void; onEdit: () => void; onRegenerate: () => void; }> = ({ message, onReact, onCopy, onEdit, onRegenerate }) => {
  return (
